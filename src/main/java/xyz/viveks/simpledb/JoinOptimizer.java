...
public class JoinOptimizer {
   ...
   *
   * <p>The cost of the join should be calculated based on the join algorithm (or algorithms) that
   * you implemented for Lab 2. It should be a function of the amount of data that must be read over
   * the course of the query, as well as the number of CPU opertions performed by your join. Assume
   * that the cost of a single predicate application is roughly 1.
   *
   ...
   */
  public double estimateJoinCost(
      LogicalJoinNode j, int card1, int card2, double cost1, double cost2) {
