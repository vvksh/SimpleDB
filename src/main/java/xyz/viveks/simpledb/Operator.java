 ...
 * <code>hasNext</code>. Subclasses only need to implement <code>open</code> and <code>readNext
 * </code>.
 */
public abstract class Operator implements OpIterator {
   ...
   *     array of only one element. For join operators, the order of the children is not important.
   *     But they should be consistent among multiple calls.
   */
