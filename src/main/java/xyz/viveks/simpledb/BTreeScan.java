...
public class BTreeScan implements OpIterator {
   ...
   * @param ipred The index predicate to match. If null, the scan will return all tuples in sorted
   *     order
   */
  ...
  public void reset(int tableid, String tableAlias) {
    ...
    if (ipred == null) {
      ...
      this.it =
          ((BTreeFile) Database.getCatalog().getDatabaseFile(tableid)).indexIterator(tid, ipred);
    }
  ...
  public void open() throws DbException, TransactionAbortedException {
    if (isOpen) throw new DbException("double open on one OpIterator.");
