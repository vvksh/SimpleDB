 ...
 * xyz.viveks.xyz.viveks.simpledb.xyz.viveks.simpledb.Debug. For example, on the command line, use -Dsimpledb.Debug=x,
...
public class Debug {
  ...
  static {
      String debug = System.getProperty("xyz.viveks.xyz.viveks.simpledb.xyz.viveks.simpledb.Debug");
      if (debug == null) {
